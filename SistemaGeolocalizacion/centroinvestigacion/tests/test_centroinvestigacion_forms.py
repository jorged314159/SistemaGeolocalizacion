...
from centroinvestigacion.forms import FormCentroInvestigacion, FormEnfoque
...
class TestFormCentroInvestigacion(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.data_Centro = {
            'nombre': 'Quantum',
            'direccion': 'Callejon IPN, S/N, Centro, 98000, Zacatecas',
            'latitud': '22.7844428',
            'longitud': '-102.6119024',
            'telefono': '4929212816',
            'enfoque': None
        }
    ...
    def test_centro_form_nombre_max_caracteres(self):
        ...
        form = FormCentroInvestigacion(self.data_Centro)
        self.assertEqual(form.errors['nombre'], ['Asegúrese de que este valor tenga como máximo 50 caracteres (tiene 51).'])
    ...
    def test_centro_form_direccion_max_caracteres(self):
        ...
        form = FormCentroInvestigacion(self.data_Centro)
        self.assertEqual(form.errors['direccion'], ['Asegúrese de que este valor tenga como máximo 150 caracteres (tiene 151).'])
    ...
    def test_centro_form_telefono_max_caracteres(self):
        ...
        form = FormCentroInvestigacion(self.data_Centro)
        self.assertEqual(form.errors['telefono'], ['Asegúrese de que este valor tenga como máximo 10 caracteres (tiene 11).'])
