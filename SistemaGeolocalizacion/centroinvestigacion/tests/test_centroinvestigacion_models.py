...
class TestCentrosInvestigacionModels(unittest.TestCase):
    ...
    def test_nombre_centro_duplicado(self):
        ...
        try:
            ...
            self.assertEqual(
                mensaje, 'Ya existe un/a Centro investigacion con este/a Nombre.')
    ...
    def test_direccion_centro_duplicada(self):
        ...
        try:
            ...
            self.assertEqual(
                mensaje, 'Ya existe un/a Centro investigacion con este/a Direccion.')
    ...
    def test_telefono_centro_duplicado(self):
        ...
        try:
            ...
            self.assertEqual(
                mensaje, 'Ya existe un/a Centro investigacion con este/a Telefono.')
    ...
    def test_latitud_y_longitud_duplicados(self):
        ...
        try:
            ...
            self.assertEqual(
                mensaje, 'Ya existe un/a Centro investigacion con este/a Latitud.')
            self.assertEqual(
                mensaje2, 'Ya existe un/a Centro investigacion con este/a Longitud.')
    ...
    def test_nombre_enfoque_duplicado(self):
        ...
        try:
            ...
            mensaje = str(ve.message_dict['nombre'][0])
            self.assertEqual(
                mensaje, 'Ya existe un/a Enfoque con este/a Nombre.')
