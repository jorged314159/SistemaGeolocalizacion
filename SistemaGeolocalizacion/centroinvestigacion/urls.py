...
urlpatterns = [
    ...
    path('centro/eliminar/<int:id>', views.eliminar_centros, name = 'eliminar_centro'),
    
    path('enfoques', views_enfoque.ListaEnfoques.as_view(), name = 'enfoques_lista'),
    path('enfoques/nuevo', views_enfoque.NuevoEnfoqueView.as_view(), name = 'nuevo_enfoque'),
    path('enfoques/editar/<int:pk>', views_enfoque.EditarEnfoqueView.as_view(), name = 'editar_enfoque'),    
    path('enfoques/eliminar/<int:pk>', views_enfoque.EliminarEnfoqueView.as_view(), name = 'eliminar_enfoque'), 
]
